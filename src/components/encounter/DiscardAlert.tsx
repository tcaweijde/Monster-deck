...
export function DiscardAlert({ ability, triggered }: DiscardAlertProps) {
  ...
  return (
    <div
      ...
      className="fixed inset-x-0 top-4 mx-auto max-w-sm bg-red-900/90 border border-red-500 text-red-100 rounded-lg px-4 py-3 text-center text-sm cursor-pointer z-50"
    >
